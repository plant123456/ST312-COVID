...
```{r}
df_clean <- df[, colSums(is.na(df)) < 500]
...
## Select variables
```{r}
df_selected <- df_clean[, intersect(c( "longcov",
  "PSEX", "CW3_COHORT", "CW3_COVID_HOSPAD", "CW3_COVNEWILL", 
  ...
  "COVIDSYMPT_23", "GHQPRECOVID_pre", "LLI_17_pre", "OUTDOORS_4_pre", "FINANCIALMANB_pre", "SMOKING_pre", "VAPE_pre", "ALDRPP_pre", "FINANCIALMAND_post", "ALDRSP_post", "MHNOW_post", "PMED"), colnames(df_clean))]
...
```{r}
# For sex
df_selected$PSEX <- factor(df_selected$PSEX, levels = c(1, 2), labels = c("Male", "Female"))

# For cohort
df_selected$CW3_COHORT <- factor(df_selected$CW3_COHORT, levels = c(1, 2, 3, 4, 5), labels = c("C1", "C2", "C3", "C4", "C5"))

# For memory
df_selected$CW3_MEMORY <- factor(df_selected$CW3_MEMORY, levels = c(1, 2, 3, 4), labels = c("Better", "Usual", "Worse", "Much Worse"))

# For GHQ (General Health Questionnaire)
df_selected$GHQPRECOVID_pre <- factor(df_selected$GHQPRECOVID_pre, levels = c(1, 2, 3, 4, 5), labels = c("Excellent", "Very Good", "Good", "Fair", "Poor"))

# For FINANCIALMANB
df_selected$FINANCIALMANB_pre <- factor(df_selected$FINANCIALMANB_pre, levels = c(1, 2, 3, 4, 5), labels = c("Comfortable", "Satisfactory", "Managing", "Difficult", "Very Difficult"))

# For FINANCIALMAND
df_selected$FINANCIALMAND_post <- factor(df_selected$FINANCIALMAND_post, levels = c(1, 2, 3, 4, 5), labels = c("Much Worse", "Worse", "Same", "Better", "Much Better"))

# For smoking
df_selected$SMOKING_pre <- factor(df_selected$SMOKING_pre, levels = c(1, 2, 3, 4), labels = c("Never", "Formerly", "Occasionally", "Daily"))

# For vape
df_selected$VAPE_pre <- factor(df_selected$VAPE_pre, levels = c(1, 2, 3, 4), labels = c("Never", "Formerly", "Occasionally", "Daily"))

# For alcohol
df_selected$ALDRSP_post <- factor(df_selected$ALDRSP_post, levels = c(1, 2, 3, 4, 5), labels = c("Very Frequently", "Frequently", "Weekly", "Infrequently", "Never"))

# For mental health
df_selected$MHNOW_post <- factor(df_selected$MHNOW_post, levels = c(1, 2, 3, 4, 5), labels = c("Excellent", "Very Good", "Good", "Fair", "Poor"))
...
df_selected <- convert_to_yes_no(df_selected)
...
df_selected <- convert_to_yes_no2(df_selected)
...
df_selected <- convert_to_combined_categories(df_selected)
...
df_selected <- convert_to_combined_categories2(df_selected)
...
```{r}
lca_all <- poLCA(cbind(PSEX, CW3_COHORT, CW3_COVID_HOSPAD, CW3_COVNEWILL, 
CW3_FATGRID_1, CW3_FATGRID_2, CW3_FATGRID_3, CW3_FATGRID_4, 
CW3_FATGRID_5, CW3_FATGRID_6, CW3_FATGRID_7, CW3_FATGRID_8, 
CW3_FATGRID_9, CW3_FATGRID_10, CW3_MEMORY, CW3_SKIN, CW3_SHORTB, CW3_PALP, CW3_ACTIVITY, COVIDSYMPT_1, COVIDSYMPT_2, COVIDSYMPT_3, COVIDSYMPT_4, COVIDSYMPT_5, COVIDSYMPT_6, 
COVIDSYMPT_7, COVIDSYMPT_8, COVIDSYMPT_18, 
...
```{r}
model_1_class <- poLCA(cbind(PSEX, CW3_COHORT, CW3_COVID_HOSPAD, CW3_COVNEWILL, 
CW3_FATGRID_1, CW3_FATGRID_2, CW3_FATGRID_3, CW3_FATGRID_4, 
CW3_FATGRID_5, CW3_FATGRID_6, CW3_FATGRID_7, CW3_FATGRID_8, 
CW3_FATGRID_9, CW3_FATGRID_10, CW3_MEMORY, CW3_SKIN, CW3_SHORTB, CW3_PALP, CW3_ACTIVITY, COVIDSYMPT_1, COVIDSYMPT_2, COVIDSYMPT_3, COVIDSYMPT_4, COVIDSYMPT_5, COVIDSYMPT_6, 
COVIDSYMPT_7, COVIDSYMPT_8, COVIDSYMPT_18, 
...
COVIDSYMPT_16, COVIDSYMPT_13, COVIDSYMPT_14, 
COVIDSYMPT_17, COVIDSYMPT_19, COVIDSYMPT_20, 
COVIDSYMPT_23, GHQPRECOVID_pre, LLI_17_pre, OUTDOORS_4_pre, FINANCIALMANB_pre, SMOKING_pre, VAPE_pre, ALDRPP_pre, FINANCIALMAND_post, ALDRSP_post, MHNOW_post, PMED) ~ 1, data = df_selected, nclass = 1)

model_2_classes <- poLCA(cbind(PSEX, CW3_COHORT, CW3_COVID_HOSPAD, CW3_COVNEWILL, 
CW3_FATGRID_1, CW3_FATGRID_2, CW3_FATGRID_3, CW3_FATGRID_4, 
CW3_FATGRID_5, CW3_FATGRID_6, CW3_FATGRID_7, CW3_FATGRID_8, 
CW3_FATGRID_9, CW3_FATGRID_10, CW3_MEMORY, CW3_SKIN, CW3_SHORTB, CW3_PALP, CW3_ACTIVITY, COVIDSYMPT_1, COVIDSYMPT_2, COVIDSYMPT_3, COVIDSYMPT_4, COVIDSYMPT_5, COVIDSYMPT_6, 
COVIDSYMPT_7, COVIDSYMPT_8, COVIDSYMPT_18, 
...
COVIDSYMPT_16, COVIDSYMPT_13, COVIDSYMPT_14, 
COVIDSYMPT_17, COVIDSYMPT_19, COVIDSYMPT_20, 
COVIDSYMPT_23, GHQPRECOVID_pre, LLI_17_pre, OUTDOORS_4_pre, FINANCIALMANB_pre, SMOKING_pre, VAPE_pre, ALDRPP_pre, FINANCIALMAND_post, ALDRSP_post, MHNOW_post, PMED) ~ 1, data = df_selected, nclass = 2)

model_3_classes <- poLCA(cbind(PSEX, CW3_COHORT, CW3_COVID_HOSPAD, CW3_COVNEWILL, 
CW3_FATGRID_1, CW3_FATGRID_2, CW3_FATGRID_3, CW3_FATGRID_4, 
CW3_FATGRID_5, CW3_FATGRID_6, CW3_FATGRID_7, CW3_FATGRID_8, 
CW3_FATGRID_9, CW3_FATGRID_10, CW3_MEMORY, CW3_SKIN, CW3_SHORTB, CW3_PALP, CW3_ACTIVITY, COVIDSYMPT_1, COVIDSYMPT_2, COVIDSYMPT_3, COVIDSYMPT_4, COVIDSYMPT_5, COVIDSYMPT_6, 
COVIDSYMPT_7, COVIDSYMPT_8, COVIDSYMPT_18, 
...
COVIDSYMPT_16, COVIDSYMPT_13, COVIDSYMPT_14, 
COVIDSYMPT_17, COVIDSYMPT_19, COVIDSYMPT_20, 
COVIDSYMPT_23, GHQPRECOVID_pre, LLI_17_pre, OUTDOORS_4_pre, FINANCIALMANB_pre, SMOKING_pre, VAPE_pre, ALDRPP_pre, FINANCIALMAND_post, ALDRSP_post, MHNOW_post, PMED) ~ 1, data = df_selected, nclass = 3)

model_4_classes <- poLCA(cbind(PSEX, CW3_COHORT, CW3_COVID_HOSPAD, CW3_COVNEWILL, CW3_FATGRID_1, CW3_FATGRID_2, CW3_FATGRID_3, CW3_FATGRID_4, 
CW3_FATGRID_5, CW3_FATGRID_6, CW3_FATGRID_7, CW3_FATGRID_8, 
CW3_FATGRID_9, CW3_FATGRID_10, CW3_MEMORY, CW3_SKIN, CW3_SHORTB, CW3_PALP, CW3_ACTIVITY, COVIDSYMPT_1, COVIDSYMPT_2, COVIDSYMPT_3, COVIDSYMPT_4, COVIDSYMPT_5, COVIDSYMPT_6, 
COVIDSYMPT_7, COVIDSYMPT_8, COVIDSYMPT_18, 
COVIDSYMPT_10, COVIDSYMPT_11, COVIDSYMPT_12, 
COVIDSYMPT_16, COVIDSYMPT_13, COVIDSYMPT_14, 
COVIDSYMPT_17, COVIDSYMPT_19, COVIDSYMPT_20, 
COVIDSYMPT_23, GHQPRECOVID_pre, LLI_17_pre, OUTDOORS_4_pre, FINANCIALMANB_pre, SMOKING_pre, VAPE_pre, ALDRPP_pre, FINANCIALMAND_post, ALDRSP_post, MHNOW_post, PMED) ~ 1, data = df_selected, nclass = 4)
...
```
lowest AIC and BIC value for 4 clusters
...
```{r}
df_complete <- df_selected[complete.cases(df_selected), ]
df_complete$LCA_class <- lca_all$predclass

table(df_complete$LCA_class, df_complete$longcov)
prop.table(table(df_complete$LCA_class, df_complete$longcov), 1)
```
## Bar plot of long covid distriubtion
```{r}
# Create a summary table
df_summary <- as.data.frame(prop.table(table(df_complete$LCA_class, df_complete$longcov), 1))
...
## Chi-square test
```{r}
chisq.test(table(df_complete$LCA_class, df_complete$longcov))
```
...
# For cohort
selected_df$CW3_COHORT <- factor(selected_df$CW3_COHORT, levels = c(1, 2, 3, 4, 5), labels = c("C1", "C2", "C3", "C4", "C5"))
...
# LCA model for individuals with long covid
```{r}
lca_model <- poLCA(cbind(PSEX, CW3_COHORT, CW3_COVID_HOSPAD, CW3_COVNEWILL, 
CW3_FATGRID_1, CW3_FATGRID_2, CW3_FATGRID_3, CW3_FATGRID_4, 
CW3_FATGRID_5, CW3_FATGRID_6, CW3_FATGRID_7, CW3_FATGRID_8, 
CW3_FATGRID_9, CW3_FATGRID_10, CW3_MEMORY, CW3_SKIN, CW3_SHORTB, CW3_PALP, CW3_ACTIVITY, COVIDSYMPT_1, COVIDSYMPT_2, COVIDSYMPT_3, COVIDSYMPT_4, COVIDSYMPT_5, COVIDSYMPT_6, 
COVIDSYMPT_7, COVIDSYMPT_8, COVIDSYMPT_18, 
...
pie(class_proportions, labels = paste("Class", 1:length(class_proportions), ":", round(class_proportions * 100, 1), "%"),
    main = "Latent Class Proportions for Long Covid Individuals")
```
