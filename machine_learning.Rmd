...
# Logistic regression
```{r}
log_mod <- glm(longcov ~ . - ID - CW3_COVID19, data = df_complete, family = binomial)

summary(log_mod)
```
Significant predictors from initial logistic regression: CW3_COVID19POS, CW3_COVID_HOSPAD, CW3_COVNEWILL, CW3_FATGRID_1, CW3_FATGRID_3, CW3_MEMORY, CW3_SHORTB, CW3_ACTIVITY, GHQPRECOVID_pre, HSLEEPPP_pre
...
## Best model
```{r}
best_model <- randomForest(longcov ~ . - ID, data = df_complete, mtry = 5, ntree = 500)
