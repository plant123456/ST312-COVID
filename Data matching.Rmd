...
w1_vars <- c(
  ...
  "CW1_HSLEEPSP", "CW1_Weight", "CW1_WGHTKG", "CW1_SATN", "CW1_WGHTSTP_4", "CW1_WGHTSTP_5"
)
...
#Dropping the old weight variables
```{r}
...
```{r}
# 1. Save wave1_clean
#write.xlsx(wave3_not_new, file = "merged_wave_data_w1&2participants.xlsx")
```
